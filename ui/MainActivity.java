package org.jackie.corvallisrecycler_final_project.ui;
...
import org.jackie.corvallisrecycler_final_project.directory.Category;
import org.jackie.corvallisrecycler_final_project.directory.CategoryActivity;
...
public class MainActivity extends ActionBarActivity {
    ...
    public void goToPage1(View view){
        if (isNetworkAvailable()) {
            goToUrl("http://site.republicservices.com/site/corvallis-or/en/documents/corvallisrecycledepot.pdf");
        }else {
    ...
    public void goToPage2(View view){
        if (isNetworkAvailable()) {
            goToUrl("http://site.republicservices.com/site/corvallis-or/en/documents/detailedrecyclingguide.pdf");
        }else {
            Toast.makeText(this, getString(R.string.network_unavailable_message),
                    Toast.LENGTH_LONG).show();
        }
